...
def facial_processing(faceCoordinates,num_people):
    ...
    predictor   = dlib.shape_predictor('/home/cpage/Desktop/CapstoneTest1/mcr4-version-1.0/shape_predictor_68_face_landmarks.dat')
    ...
    # Loop over frames froim the video stream
    while True:
        ...
        cv2.line(frame, (0, frame.shape[0] // 2), (frame.shape[1], frame.shape[0] // 2), (255, 255, 255), 1)  # Horizontal
        cv2.line(frame, (frame.shape[1] // 2, 0), (frame.shape[1] // 2, frame.shape[0]), (255, 255, 255), 1)  # Vertical        
        ...
        if rect!=None:
            ...
            num_people.value = 1
            # Draw a red circle at the center of the face
            center_x = ((rect.left() + rect.right()) // 2)
            center_y = ((rect.top() + rect.bottom()) // 2)
            cv2.circle(frame, (center_x, center_y), 5, (0, 0, 255), -1)  # Red circle	    
	    
            faceCoordinates[0] = center_x - 320
            faceCoordinates[1] = center_y - 240
            ...
            if distracton_initialized==True:
                ...
                if time.time()- distracton_start_time> DISTRACTION_INTERVAL:
                    ...
                    with open(r'/home/cpage/Desktop/CapstoneTest1/mcr4-version-1.0/output.txt', "a+") as file_object:
